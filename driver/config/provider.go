...
func (p *DefaultProvider) getConfig(ctx context.Context) *configx.Provider {
...
func (p *DefaultProvider) Set(ctx context.Context, key string, value interface{}) error {
	return p.getConfig(ctx).Set(key, value)
}
...
func (p *DefaultProvider) InsecureRedirects(ctx context.Context) []string {
	return p.getConfig(ctx).Strings("dangerous-allow-insecure-redirect-urls")
}
...
func (p *DefaultProvider) WellKnownKeys(ctx context.Context, include ...string) []string {
	...
	return stringslice.Unique(append(p.getConfig(ctx).Strings(KeyWellKnownKeys), include...))
}
...
func (p *DefaultProvider) ClientHTTPNoPrivateIPRanges(ctx context.Context) bool {
	return p.getConfig(ctx).Bool(ViperKeyClientHTTPNoPrivateIPRanges)
}

func (p *DefaultProvider) AllowedTopLevelClaims(ctx context.Context) []string {
	return stringslice.Unique(p.getConfig(ctx).Strings(KeyAllowedTopLevelClaims))
}

func (p *DefaultProvider) SubjectTypesSupported(ctx context.Context) []string {
	types := stringslice.Filter(
		p.provider.StringsF(KeySubjectTypesSupported, []string{"public"}),
		func(s string) bool {
...
func (p *DefaultProvider) DefaultClientScope(ctx context.Context) []string {
	return p.getConfig(ctx).StringsF(
...
func (p *DefaultProvider) DSN(ctx context.Context) string {
	dsn := p.getConfig(ctx).String(KeyDSN)
...
func (p *DefaultProvider) EncryptSessionData(ctx context.Context) bool {
	return p.getConfig(ctx).BoolF(KeyEncryptSessionData, true)
}

func (p *DefaultProvider) ExcludeNotBeforeClaim(ctx context.Context) bool {
	return p.getConfig(ctx).BoolF(KeyExcludeNotBeforeClaim, false)
}

func (p *DefaultProvider) DataSourcePlugin(ctx context.Context) string {
	return p.getConfig(ctx).String(KeyDSN)
}

func (p *DefaultProvider) CookieSameSiteMode(ctx context.Context) http.SameSite {
	sameSiteModeStr := p.getConfig(ctx).String(KeyCookieSameSiteMode)
...
func (p *DefaultProvider) PublicAllowDynamicRegistration(ctx context.Context) bool {
	return p.getConfig(ctx).Bool(KeyPublicAllowDynamicRegistration)
}

func (p *DefaultProvider) CookieSameSiteLegacyWorkaround(ctx context.Context) bool {
	return p.getConfig(ctx).Bool(KeyCookieSameSiteLegacyWorkaround)
}

func (p *DefaultProvider) ConsentRequestMaxAge(ctx context.Context) time.Duration {
	return p.getConfig(ctx).DurationF(KeyConsentRequestMaxAge, time.Minute*30)
}

func (p *DefaultProvider) Tracing(ctx context.Context) *otelx.Config {
	return p.getConfig(ctx).TracingConfig("Ory Hydra")
}

func (p *DefaultProvider) GetCookieSecrets(ctx context.Context) [][]byte {
	secrets := p.getConfig(ctx).Strings(KeyGetCookieSecrets)
	if len(secrets) == 0 {
...
func (p *DefaultProvider) LogoutRedirectURL(ctx context.Context) *url.URL {
	return urlRoot(p.getConfig(ctx).RequestURIF(KeyLogoutRedirectURL, p.publicFallbackURL(ctx, "oauth2/fallbacks/logout/callback")))
}
...
func (p *DefaultProvider) LoginURL(ctx context.Context) *url.URL {
	return urlRoot(p.getConfig(ctx).URIF(KeyLoginURL, p.publicFallbackURL(ctx, "oauth2/fallbacks/login")))
}

func (p *DefaultProvider) LogoutURL(ctx context.Context) *url.URL {
	return urlRoot(p.getConfig(ctx).RequestURIF(KeyLogoutURL, p.publicFallbackURL(ctx, "oauth2/fallbacks/logout")))
}

func (p *DefaultProvider) ConsentURL(ctx context.Context) *url.URL {
	return urlRoot(p.getConfig(ctx).URIF(KeyConsentURL, p.publicFallbackURL(ctx, "oauth2/fallbacks/consent")))
}

func (p *DefaultProvider) ErrorURL(ctx context.Context) *url.URL {
	return urlRoot(p.getConfig(ctx).RequestURIF(KeyErrorURL, p.publicFallbackURL(ctx, "oauth2/fallbacks/error")))
}

func (p *DefaultProvider) PublicURL(ctx context.Context) *url.URL {
	return urlRoot(p.getConfig(ctx).RequestURIF(KeyPublicURL, p.IssuerURL(ctx)))
}

func (p *DefaultProvider) IssuerURL(ctx context.Context) *url.URL {
	issuerURL := p.getConfig(ctx).RequestURIF(KeyIssuerURL, p.fallbackURL(ctx, "/", p.host(ctx, PublicInterface), p.port(ctx, PublicInterface)))
...
func (p *DefaultProvider) OAuth2ClientRegistrationURL(ctx context.Context) *url.URL {
	return p.getConfig(ctx).RequestURIF(KeyOAuth2ClientRegistrationURL, new(url.URL))
}

func (p *DefaultProvider) OAuth2TokenURL(ctx context.Context) *url.URL {
	return p.getConfig(ctx).RequestURIF(KeyOAuth2TokenURL, urlx.AppendPaths(p.PublicURL(ctx), "/oauth2/token"))
}

func (p *DefaultProvider) OAuth2AuthURL(ctx context.Context) *url.URL {
	return p.getConfig(ctx).RequestURIF(KeyOAuth2AuthURL, urlx.AppendPaths(p.PublicURL(ctx), "/oauth2/auth"))
}

func (p *DefaultProvider) JWKSURL(ctx context.Context) *url.URL {
	return p.getConfig(ctx).RequestURIF(KeyJWKSURL, urlx.AppendPaths(p.IssuerURL(ctx), "/.well-known/jwks.json"))
}

func (p *DefaultProvider) TokenRefreshHookURL(ctx context.Context) *url.URL {
	return p.getConfig(ctx).URIF(KeyRefreshTokenHookURL, nil)
}

func (p *DefaultProvider) AccessTokenStrategy(ctx context.Context) AccessTokenStrategyType {
	s, err := ToAccessTokenStrategyType(p.getConfig(ctx).String(KeyAccessTokenStrategy))
	if err != nil {
...
func (p *DefaultProvider) SubjectIdentifierAlgorithmSalt(ctx context.Context) string {
	return p.getConfig(ctx).String(KeySubjectIdentifierAlgorithmSalt)
}
...
func (p *DefaultProvider) OIDCDiscoverySupportedClaims(ctx context.Context) []string {
	return stringslice.Unique(
		append(
			[]string{"sub"},
			p.getConfig(ctx).Strings(KeyOIDCDiscoverySupportedClaims)...,
		),
	)
}
